...
const vec3 ambient_light = vec3(0.20, 0.20, 0.20);
...
//	normal = normalize(normal * 2.0 - 1.0);
	...
	//FragmentColor = vec4(diffuse_component * final_specular_color + specular_component * final_specular_color, 1.0);
	//FragmentColor = vec4(final_ambient_color + final_diffuse_color + final_specular_color,1.0);
